...
var config = {
  apiOrigins: {
    ...
    production: 'https://present-recollection-rails-api.herokuapp.com'
  }
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "\n  <h1 class=\"center\">Present Recolleciton</h1>\n  <p>\n    My fiance is has always been the best gift giver. It always blew my mind when she continuously picked the perfect present. How did she come up with such brilliance? The solution? Simple! Everytime one her friends or family mentioned something that they liked she would simply write it down!\n  </p>\n  <p>\n    Who would use this? Who wouldn't use this! Your mom! Your dad! Your siblings! Any good friend!!!\n  </p>\n  <p>\n    I wanted to make this simple easy to use app, one that I would use.\n  </p>\n  </p>\n<h1 class=\"\">How to use</h1>\n<ul>\n  <li>Create Account</li>\n  <li>Log in</li>\n  <li>Add a friend</li>\n  <li>If you misspell your friends name, or write the wrong birthday, go edit friend</li>\n  <li>If you want to remove a friend from the list click delete and confirm deletion</li>\n  <li>Click on your friend to create a gift / view gifts associated with that friend</li>\n  <li>Add a gift to that friend. You'll know which friend because their name will be at the top</li>\n  <li>If you want to update the gift, press update, and you can go ahead and edit!</li>\n  <li>If you have bought the gift for your friend, or think it's no longer a great idea click delete, and then confirm deletion</li>\n  <li>When you're done creating gifts, click back and go add more friends and gifts!</li>\n  <li>You now have no good reason to forget your friends presents ideas! Just write 'em down!</li>\n</ul>\n";
},"useData":true});
...
var displayFriendsTemplate = __webpack_require__(41);
var newFriendFormTemplate = __webpack_require__(42);
var addPopovers = __webpack_require__(11);
var updateFriendModalTemplate = __webpack_require__(43);

var displayFriendsSuccess = function displayFriendsSuccess(data) {
  // console.log(data.friends)
  var displayFriendsHTML = displayFriendsTemplate({ friends: data.friends });
  $('#content').html(displayFriendsHTML);
  addPopovers(data.friends, 'friend');
};
var clickBack = function clickBack(data) {
  // console.log(data.friends)
  $('#message').text('');
  var displayFriendsHTML = displayFriendsTemplate({ friends: data.friends });
  $('#content').html(displayFriendsHTML);
...
var displayFriendsFailure = function displayFriendsFailure(e) {
  $('#message').text('Unable to retrieve friends... Sad day...');
  // console.log('ui display error', e)
};

var addFriendSuccess = function addFriendSuccess(data) {
  var friend = data.friend.nickname;
  $('#present-recollection-modal').modal('toggle');
  $('#message').text('Click on a ' + friend + ' to add gift ideas');
};

var addFriendFailure = function addFriendFailure(that) {
  that.reset();
  $('#present-recollection-modal').modal('toggle');
  $('#message').text('Unable to add friends... Maybe you\'re not that close?');
};

var loadNewFriendForm = function loadNewFriendForm() {
  // console.log('inside loadNewFriendForm', data)

  var newFriendFormHTML = newFriendFormTemplate();
  $('#present-recollection-modal').html(newFriendFormHTML);
  $('#present-recollection-modal').modal('toggle');
};

var fillUpdateFriendModal = function fillUpdateFriendModal(data) {
  // console.log(data.friend)
  var updateFriendModalHTML = updateFriendModalTemplate({ friend: data.friend });
  $('#present-recollection-modal').html(updateFriendModalHTML);
  $('#present-recollection-modal').modal('toggle');
};
var retrieveFriendFailure = function retrieveFriendFailure(e) {
  $('#message').text('Not sure what went wrong. Unable to retrieve gift');
  // console.log('ui display error', e)
};

var updateFriendSuccess = function updateFriendSuccess(data) {
  $('#present-recollection-modal').modal('toggle');
  $('#message').text('You\'re Friend has been updated');
};

var updateFriendFailure = function updateFriendFailure() {
  $('#present-recollection-modal').modal('toggle');
  $('#message').text('Unable to update Friend. They\'re perfect the way they are!');
};

var deleteFriendSuccess = function deleteFriendSuccess(id) {
  $('#message').text('Your friend has been removed');
  $('.friend-' + id).remove();
};

var deleteFriendFailure = function deleteFriendFailure() {
  $('#message').text('Unable to remove friend.  My bad.');
};

module.exports = {
  displayFriendsSuccess: displayFriendsSuccess,
  displayFriendsFailure: displayFriendsFailure,
  loadNewFriendForm: loadNewFriendForm,
  addFriendSuccess: addFriendSuccess,
  addFriendFailure: addFriendFailure,
  fillUpdateFriendModal: fillUpdateFriendModal,
  retrieveFriendFailure: retrieveFriendFailure,
  updateFriendSuccess: updateFriendSuccess,
  updateFriendFailure: updateFriendFailure,
  deleteFriendSuccess: deleteFriendSuccess,
  deleteFriendFailure: deleteFriendFailure,
  clickBack: clickBack
};
...
var addPopovers = function addPopovers(items, name) {
  var captilize = function captilize(str) {
...
var friendApi = __webpack_require__(13);

var onDisplayGifts = function onDisplayGifts(id) {
  friendApi.retrieveFriend(id).then(ui.displayGiftSuccess).catch(ui.displayGiftFailure);
};

var onOpenUpdateGiftModal = function onOpenUpdateGiftModal(data) {
  var id = data.target.dataset.id;
  api.retrieveGift(id).then(ui.fillUpdateGiftModal).catch(ui.retrieveGiftFailure);
};

var onNewGift = function onNewGift(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.newGift(data).then(ui.newGiftSuccess).then(onDisplayGifts).catch(ui.newGiftFailure);
};

var onUpdateGift = function onUpdateGift(event) {
  var data = getFormFields(this);
  event.preventDefault();
  this.reset();
  api.updateGift(data).then(ui.updateGiftSuccess).then(onDisplayGifts).catch(ui.updateGiftFailure);
};

var onDeleteGift = function onDeleteGift(event) {
  var id = event.target.dataset.id;
  api.deleteGift(id).then(function () {
    return ui.deleteGiftSuccess(id);
...
var addFriend = function addFriend(data) {
  return $.ajax({
...
var retrieveFriend = function retrieveFriend(id) {
  return $.ajax({
...
var updateFriend = function updateFriend(data) {
  return $.ajax({
...
var giftEvents = __webpack_require__(12);
var friendEvents = __webpack_require__(49);
var otherEvents = __webpack_require__(50);
...
var store = __webpack_require__(3);
var gift = __webpack_require__(10);
...
var onSignUp = function onSignUp(event) {
  ...
  if (data.credentials.password === data.credentials.password_confirmation) {
    api.signUp(data).then(function () {
      return ui.signUpSuccess(_this);
    }).catch(function () {
      return ui.signUpFailure(_this);
    });
  } else {
...
var onSignIn = function onSignIn(event) {
  ...
  var data = getFormFields(this);
  event.preventDefault();
  api.signIn(data).then(ui.signInSuccess).then(gift.displayFriendsSuccess).catch(function () {
    return ui.signInFailure(_this2);
  });
};
...
var onChangePassword = function onChangePassword(event) {
  ...
  if (data.passwords.new === data.passwords['new-retyped']) {
    ...
    api.changePassword(data).then(function () {
      return ui.changePasswordSuccess(_this3);
    }).catch(function () {
      return ui.changePasswordFailure(_this3);
    });
  } else {
    ui.passwordMismatch(this);
  }
...
var onOpenSignUpModal = function onOpenSignUpModal() {
  return ui.openSignUpModal();
};
var onOpenChangePasswordModal = function onOpenChangePasswordModal() {
  return ui.openChangePasswordModal();
};
var onOpenSignInModal = function onOpenSignInModal() {
  return ui.openSignInModal();
};
...
var store = __webpack_require__(3);
var mainPageTemplate = __webpack_require__(8);
var signUpTemplate = __webpack_require__(38);
var signInTemplate = __webpack_require__(39);
var changePasswordTemplate = __webpack_require__(40);

var signUpSuccess = function signUpSuccess(that) {
...
var passwordMismatch = function passwordMismatch(that) {
  that.reset();
...
var sameAsOld = function sameAsOld(that) {
  that.reset();
  // focus on first input after reset!
  formFocus(that);
...
var signUpFailure = function signUpFailure(that) {
  that.reset();
  formFocus(that);
...
var signInFailure = function signInFailure(that) {
  that.reset();
  formFocus(that);
  $('#modal-message').text('Invalid username or password');
};

var changePasswordSuccess = function changePasswordSuccess(that) {
  that.reset();
  $('.navbar-collapse').collapse('hide');
  $('#present-recollection-modal').modal('toggle');
...
var changePasswordFailure = function changePasswordFailure(that) {
  that.reset();
  formFocus(that);
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"modal-dialog\" role=\"document\">\n  <div class=\"modal-content\">\n    <div class=\"modal-header\">\n      <h2 class=\"modal-title\">Sign Up</h2>\n      <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n    </div>\n    <div class=\"modal-body\">\n      <form id=\"sign-up\" class=\"form-horizontal\">\n        <div class=\"form-group\">\n          <label class=\"hidden-xs col-sm-2 control-label\">Email:</label>\n          <div class=\"col-sm-10\">\n            <input class=\"form-control\" name=\"credentials[email]\" type=\"text\" placeholder=\"Email\" required />\n          </div>\n        </div>\n        <div class=\"form-group\">\n          <label class=\"hidden-xs col-sm-2 control-label\">Password:</label>\n          <div class=\"col-sm-10\">\n            <input class=\"form-control\" name=\"credentials[password]\" type=\"password\" placeholder=\"Password\" required />\n          </div>\n        </div>\n        <div class=\"form-group\">\n          <label class=\"hidden-xs col-sm-2 control-label\">Retype Password:</label>\n          <div class=\"col-sm-10\">\n            <input class=\"form-control\" name=\"credentials[password_confirmation]\" type=\"password\" placeholder=\"Retype Password\" required />\n          </div>\n        </div>\n        <input type=\"submit\" class=\"btn btn-primary form-control\" value=\"Submit!\" />\n      </form>\n    </div>\n    <div class=\"modal-footer\">\n      <span id=\"modal-message\"></span>\n      <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n    </div>\n  </div>\n</div>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"modal-dialog\" role=\"document\">\n  <div class=\"modal-content\">\n    <div class=\"modal-header\">\n      <h2 class=\"modal-title\">Change Password</h2>\n      <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n    </div>\n    <div class=\"modal-body\">\n      <form id=\"change-password\" class=\"form-horizontal\">\n        <div class=\"form-group\">\n          <label class=\"hidden-xs col-sm-2 control-label\">Current Password:</label>\n          <div class=\"col-sm-10\">\n            <input class=\"form-control\" name=\"passwords[old]\" type=\"password\" placeholder=\"Current Password\" required />\n          </div>\n        </div>\n        <div class=\"form-group\">\n          <label class=\"hidden-xs col-sm-2 control-label\">New Password:</label>\n          <div class=\"col-sm-10\">\n            <input class=\"form-control\" name=\"passwords[new]\" type=\"password\" placeholder=\"New Password\" required />\n          </div>\n        </div>\n        <div class=\"form-group\">\n          <label class=\"hidden-xs col-sm-2 control-label\">Retype New Password:</label>\n          <div class=\"col-sm-10\">\n            <input class=\"form-control\" name=\"passwords[new-retyped]\" type=\"password\" placeholder=\"Retype New Password\"required />\n          </div>\n        </div>\n        <input type=\"submit\" class=\"btn btn-primary form-control\" value=\"Submit!\" />\n      </form>\n    </div>\n    <div class=\"modal-footer\">\n      <span id=\"modal-message\"></span>\n      <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n    </div>\n  </div>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"row friend-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <div class=\"col col-sm-6 col-sm-offset-2 col-xs-8\">\n      <div class=\"panel panel-primary\">\n        <div class=\"panel-heading show-gifts\">\n          <h3 class=\"panel-title\">\n            <span>"
    ...
    + "</span>\n          </h3>\n        </div>\n      </div>\n    </div>\n    <div class=\"col col-xs-4\">\n      <!-- update to icon, and Verical-Align -->\n        <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\" class=\"btn btn-danger\" data-container=\"body\" data-toggle=\"popover-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-trigger=\"focus\">\n          Delete\n        </button>\n\n        <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class='friend-update btn btn-warning'>\n          Modify\n        </button>\n\n    </div>\n  </div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<button class=\"btn btn-success btn-lg btn-center\" type=\"button\" id=\"new-friend\">Add Friend</button>\n<div class=\"resource-section\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.friends : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</div>\n";
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <h2 class=\"modal-title\">Create Friend</h2>\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n              <span aria-hidden=\"true\">&times;</span>\n            </button>\n      </div>\n      <div class=\"modal-body\">\n\n    <form id=\"add-friend\" class=\"form-horizontal\">\n\n      <div class=\"form-group\">\n        <label class=\"hidden-xs col-sm-2 control-label\">Nickname:</label>\n        <div class=\"col-sm-10\">\n          <input class=\"form-control\" name=\"friend[nickname]\" type=\"text\" placeholder=\"Nickname\" required />\n        </div>\n      </div>\n      <div class=\"form-group\">\n        <label class=\"hidden-xs col-sm-2 control-label\">Birthday:</label>\n        <div class=\"col-sm-10\">\n          <input class=\"form-control\" name=\"friend[dob]\" type=\"date\" value=\"1970-01-27\" required />\n        </div>\n      </div>\n\n      <input type=\"submit\" class=\"btn btn-primary form-control\" value=\"Create!\" />\n\n    </form>\n  </div>\n  <div class=\"modal-footer\">\n    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n  </div>\n</div>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"modal-dialog\" role=\"document\">\n  <div class=\"modal-content\">\n    <div class=\"modal-header\">\n      <h2 class=\"modal-title\">Update Friend "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.friend : depth0)) != null ? stack1.dob : stack1), depth0))
    + "</h2>\n      <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n    </div>\n    <div class=\"modal-body\">\n      <form id=\"update-friend\" class=\"form-horizontal\">\n\n\n        <div class=\"form-group\">\n          <label class=\"hidden-xs col-sm-2 control-label\">Nickname:</label>\n          <div class=\"col-sm-10\">\n            <input class=\"form-control\" name=\"friend[nickname]\" type=\"text\" placeholder=\"Nickname\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.friend : depth0)) != null ? stack1.nickname : stack1), depth0))
    + "\" required />\n          </div>\n        </div>\n        <div class=\"form-group\">\n          <label class=\"hidden-xs col-sm-2 control-label\">Birthday:</label>\n          <div class=\"col-sm-10\">\n            <input class=\"form-control\" name=\"friend[dob]\" type=\"date\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.friend : depth0)) != null ? stack1.dob : stack1), depth0))
    + "\" required />\n          </div>\n        </div>\n        <input name=\"friend[id]\" type=\"hidden\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.friend : depth0)) != null ? stack1.id : stack1), depth0))
...
var newGift = function newGift(data) {
  return $.ajax({
...
var updateGift = function updateGift(data) {
...
var displayGifts = function displayGifts() {
...
var retrieveGift = function retrieveGift(id) {
  return $.ajax({
...
var deleteGift = function deleteGift(id) {
  return $.ajax({
    url: config.apiOrigin + '/gifts/' + id,
    method: 'DELETE',
    headers: {
...
var displayGiftsTemplate = __webpack_require__(46);
var updateGiftModalTemplate = __webpack_require__(47);
var newGiftModalTemplate = __webpack_require__(48);
var addPopovers = __webpack_require__(11);

var newGiftSuccess = function newGiftSuccess(data) {
  $('#present-recollection-modal').modal('toggle');
  $('#message').text(data.gift.gift_idea + '!  What a great idea!');
  // return in order to display gifts!
  return data.gift.friend_id;
};
var newGiftFailure = function newGiftFailure(e) {
  $('#present-recollection-modal').modal('toggle');
  $('#message').text('Unable to create gift.  Maybe it was a bad idea?');
  // console.log('Error in creation', e)
};

var displayGiftSuccess = function displayGiftSuccess(data) {
  var showGiftsHTML = displayGiftsTemplate({ friend: data.friend });
  $('#content').html(showGiftsHTML);
  // $('#message').text(``)
  addPopovers(data.friend.gifts, 'gift');
};

var displayGiftFailure = function displayGiftFailure(e) {
  $('#message').text('Unable to retrieve gifts');
  // console.log('ui display error', e)
};

var retrieveGiftSuccess = function retrieveGiftSuccess(data) {
  // console.log(data.gifts)
};

var retrieveGiftFailure = function retrieveGiftFailure(e) {
  $('#message').text('Not sure what went wrong. Unable to retrieve gift');
  // console.log('ui display error', e)
};

var fillUpdateGiftModal = function fillUpdateGiftModal(data) {
  // console.log(data)
  var updateGiftModalHTML = updateGiftModalTemplate({ gift: data.gift });
  $('#present-recollection-modal').html(updateGiftModalHTML);
  $('#present-recollection-modal').modal('toggle');
};

var updateGiftSuccess = function updateGiftSuccess(data) {
  $('#present-recollection-modal').modal('toggle');
...
var updateGiftFailure = function updateGiftFailure() {
  $('#present-recollection-modal').modal('toggle');
  $('#message').text('Unable to update gift. It\'s perfect the way it is!');
};

var deleteGiftSuccess = function deleteGiftSuccess(id) {
  $('#message').text('You gift has been removed');
  $('.gift-' + id).remove();
};

var deleteGiftFailure = function deleteGiftFailure() {
  $('#message').text('Unable to remove gift. If it\'s that good, maybe you should reconsider...');
};

var openNewGiftModal = function openNewGiftModal(data) {
  var friendId = data.target.dataset.id;
  // console.log(friendId)
  var newGiftModalHTML = newGiftModalTemplate({ friendId: friendId });
  $('#present-recollection-modal').html(newGiftModalHTML);
  $('#present-recollection-modal').modal('toggle');
};

module.exports = {
  newGiftSuccess: newGiftSuccess,
  newGiftFailure: newGiftFailure,
  displayGiftSuccess: displayGiftSuccess,
  displayGiftFailure: displayGiftFailure,
  retrieveGiftSuccess: retrieveGiftSuccess,
  retrieveGiftFailure: retrieveGiftFailure,
  fillUpdateGiftModal: fillUpdateGiftModal,
  updateGiftSuccess: updateGiftSuccess,
  updateGiftFailure: updateGiftFailure,
  deleteGiftSuccess: deleteGiftSuccess,
  deleteGiftFailure: deleteGiftFailure,
  openNewGiftModal: openNewGiftModal
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div class=\"row gift-"
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.gift_idea : stack1), depth0))
    + "\n        </div>\n      </div>\n    </div>\n    <div class=\"col col-xs-4 \">\n      <!-- update to icon, and Verical-Align -->\n\n        <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\" class=\"btn btn-danger\" data-container=\"body\" data-toggle=\"popover-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-trigger=\"focus\">\n          Delete\n        </button>\n\n        <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class='gift-update btn btn-warning'>\n          Modify\n        </button>\n\n\n\n    </div>\n  </div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "\n<h1 class=\"friends-gifts\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.friend : depth0)) != null ? stack1.nickname : stack1), depth0))
    + "</h1>\n<button class=\"btn btn-primary btn-lg\" type=\"button\" id=\"load-friends\">Back to Friends</button>\n\n<button class=\"btn btn-success btn-lg\" type=\"button\" id=\"open-new-gift-modal\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.friend : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">New Gift Idea!</button>\n\n<div class=\"resource-section\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.friend : depth0)) != null ? stack1.gifts : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</div>\n";
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"modal-dialog\" role=\"document\">\n  <div class=\"modal-content\">\n    <div class=\"modal-header\">\n      <h2 class=\"modal-title\">Update Gift</h2>\n      <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n    </div>\n    <div class=\"modal-body\">\n      <form id=\"update-gift\" class=\"form-horizontal\">\n\n        <div class=\"form-group\">\n          <label class=\"hidden-xs col-sm-2 control-label\">Gift Idea:</label>\n          <div class=\"col-sm-10\">\n            <input class=\"form-control\" name=\"gift[gift_idea]\" type=\"text\" placeholder=\"Gift Idea\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.gift : depth0)) != null ? stack1.gift_idea : stack1), depth0))
    + "\" required />\n          </div>\n        </div>\n        <input name=\"gift[id]\" type=\"hidden\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.gift : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" />\n        <input type=\"submit\" class=\"btn btn-primary form-control\" value=\"Update!\" />\n\n\n\n      </form>\n    </div>\n    <div class=\"modal-footer\">\n      <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n    </div>\n  </div>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n\n<div class=\"modal-dialog\" role=\"document\">\n  <div class=\"modal-content\">\n    <div class=\"modal-header\">\n      <h2 class=\"modal-title\">Add gift idea!</h2>\n      <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n    </div>\n    <div class=\"modal-body\">\n\n      <form id=\"add-gift\" class=\"form-horizontal\">\n\n        <div class=\"form-group\">\n          <label class=\"hidden-xs col-sm-2 control-label\">Gift Idea:</label>\n          <div class=\"col-sm-10\">\n            <input class=\"form-control\" name=\"gift[gift_idea]\" type=\"text\" placeholder=\"Gift Idea\" value=\""
    + alias1(container.lambda(((stack1 = (depth0 != null ? depth0.gift : depth0)) != null ? stack1.gift_idea : stack1), depth0))
    + "\" required />\n          </div>\n        </div>\n        <input name=\"gift[friend_id]\" type=\"hidden\" value=\""
    + alias1(((helper = (helper = helpers.friendId || (depth0 != null ? depth0.friendId : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"friendId","hash":{},"data":data}) : helper)))
    + "\" />\n        <input type=\"submit\" class=\"btn btn-primary form-control\" value=\"Create!\" />\n\n      </form>\n    </div>\n    <div class=\"modal-footer\">\n      <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n    </div>\n  </div>\n</div>\n";
},"useData":true});
...
var onDeleteFriend = function onDeleteFriend(event) {
  var id = event.target.dataset.id;
  api.deleteFriend(id).then(function () {
    return ui.deleteFriendSuccess(id);
  }).catch(ui.deleteFriendFailure);
};

var onAddFriend = function onAddFriend(event) {
  var _this = this;

  var data = getFormFields(this);
  event.preventDefault();
  api.addFriend(data).then(ui.addFriendSuccess).then(onDisplayFriends).catch(function () {
    return ui.addFriendFailure(_this);
  });
};

var onDisplayFriends = function onDisplayFriends(event) {
  api.displayFriends().then(ui.displayFriendsSuccess).catch(ui.displayFriendsFailure);
};

var onClickBack = function onClickBack(event) {
  api.displayFriends().then(ui.clickBack).catch(ui.displayFriendsFailure);
};

var onOpenUpdateFriendModal = function onOpenUpdateFriendModal(data) {
  var id = data.target.dataset.id;
  api.retrieveFriend(id).then(ui.fillUpdateFriendModal).catch(ui.retrieveFriendFailure);
};

var onUpdateFriend = function onUpdateFriend(event) {
  var data = getFormFields(this);
  event.preventDefault();
  this.reset();
  api.updateFriend(data).then(ui.updateFriendSuccess).then(onDisplayFriends).catch(ui.updateFriendFailure);
};

var onClickFriend = function onClickFriend(event) {
  var id = $(event.target).parents('.row').data('id');
  $('#message').text('');
  giftEvents.onDisplayGifts(id);
};

var onLoadNewFriendForm = function onLoadNewFriendForm() {
  return ui.loadNewFriendForm();
};
...
var onOpenAboutModal = function onOpenAboutModal() {
  return ui.openAboutModal();
};
var onFocusInput = function onFocusInput(e) {
  return ui.focusInput(e);
};
var onLoadContent = function onLoadContent() {
  return ui.loadContent();
};
var onRemoveContent = function onRemoveContent() {
  return ui.removeContent();
};
...
var aboutTemplate = __webpack_require__(52);
var mainTemplate = __webpack_require__(8);
...
var focusInput = function focusInput(e) {
  ...
  e && e.target && $(e.target).find('input') && $(e.target).find('input')[0] && $(e.target).find('input')[0].focus();
};
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"modal-dialog\" role=\"document\">\n  <div class=\"modal-content\">\n    <div class=\"modal-header\">\n      <h2 class=\"modal-title\">Present Recollection</h2>\n      <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                <span aria-hidden=\"true\">&times;</span>\n              </button>\n    </div>\n    <div class=\"modal-body\">\n\n      <h2>How to use</h2>\n      <ul>\n        <li>Create Account</li>\n        <li>Log in</li>\n        <li>Add a friend</li>\n        <li>If you misspell your friends name, or write the wrong birthday, go edit friend</li>\n        <li>If you want to remove a friend from the list click delete and confirm deletion</li>\n        <li>Click on your friend to create a gift / view gifts associated with that friend</li>\n        <li>Add a gift to that friend. You'll know which friend because their name will be at the top</li>\n        <li>If you want to update the gift, press update, and you can go ahead and edit!</li>\n        <li>If you have bought the gift for your friend, or think it's no longer a great idea click delete, and then confirm deletion</li>\n        <li>When you're done creating gifts, click back and go add more friends and gifts!</li>\n        <li>You now have no good reason to forget your friends presents ideas! Just write 'em down!</li>\n      </ul>\n\n      <div>\n\n        <h2>Process</h2>\n        <p>If you would like to learn more about my process please check out my repos, either my <a href=\"https://github.com/briankeegan/present-recollection\" target=\"_blank\">front-end</a> or <a href=\"https://github.com/briankeegan/present-recollection-rails-api\" target=\"_blank\">Rails API</a>.\n          Both and more can be found at <a href=\"https://github.com/briankeegan/\" target=\"_blank\">my github</a> page!</p>\n        <p>Thanks for checking out my site!</p>\n        <p>\n          <a href=\"http://briankeegan.tech\">Brian Keegan</a>\n        </p>\n      </div>\n    </div>\n    <div class=\"modal-footer\">\n      <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n    </div>\n  </div>\n</div>\n";
},"useData":true});
